...
def get_raw_answer(intent, champion):
    ...
    if intent == 'support_socket': message_answer = 'app/api_service/my_upload/support_socket/' + champion.support_socket
...
def normalize_message(intent, message_answer, entities, champion,conversation_id):
    ...
    if intent == 'support_socket': # ImageField 
        ans = 'app/api_service/my_upload/support_socket/' + champion.support_socket
        ans = open('app/api_service/my_upload/support_socket/')
