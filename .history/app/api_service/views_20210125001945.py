...
from app import app
import json
from app.api_service.nlp_processing imprt * 
...
class ConversationView(MethodView):
    ...
    def post(self):
        ...
        entities = model.extract_entities(message_question)
        message_question = tolower_message(message_question) 
        prob, intent = model.predict(message_question)
